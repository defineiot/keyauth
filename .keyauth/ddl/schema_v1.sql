...
CREATE TABLE `third_party_users_domains_mapping` (
...
CREATE TABLE `user_invitation_records` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`inviter_id` varchar(255) NOT NULL,
`invited_user_id` varchar(255) NOT NULL DEFAULT '',
`invited_user_domain_id` varchar(255) NOT NULL DEFAULT '',
`invited_user_role_ids` varchar(255) NOT NULL DEFAULT '',
`invitation_time` int(64) NOT NULL,
`accept_time` int(64) NOT NUll DEFAULT 0,
`expire_time` int(64) NOT NUll DEFAULT 0,
`invitation_code`  varchar(255) NOT NULL DEFAULT '',
`access_project_ids` varchar(255) NOT NULL DEFAULT '',
`extra` text NOT NULL DEFAULT '',
PRIMARY KEY (`id`) 
)
ENGINE = InnoDB
...
CREATE TABLE `roles_users_mapping` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`user_id` varchar(255) NOT NULL DEFAULT '',
`domain_id` varchar(255) NOT NULL DEFAULT '',
`role_name` varchar(255) NOT NULL DEFAULT '', 
...
`build_env` varchar(255) NOT NULL DEFAULT '',
`build_at` int(64) NOT NULL DEFAULT 0,
`online_at` int(64) NOT NULL DEFAULT 0,
`offline_at` int(64) NOT NULL DEFAULT 0,
`extra` text NOT NULL DEFAULT '',
PRIMARY KEY (`id`) 
)
ENGINE = InnoDB
